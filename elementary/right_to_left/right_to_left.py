...
chunk of text where the initial strings are separated by commas. As a 
joke on the right handed robots, you should replace all cases of the 
words "right" with the word "left", even if it's a part of another word. 
...
def left_join(phrases):
    ...
    Return all strings in phrases joined with ',' and replace all 'right'
    occurances with 'left'.
